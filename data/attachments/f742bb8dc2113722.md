...
- Name: tests/auth/authentication.spec.ts >> Authentication >> TC-01: a new visitor can register and lands in the signed-in state
- Location: tests/auth/authentication.spec.ts:8:7
