...
- Name: tests/auth/authentication.spec.ts >> Authentication >> TC-02: a registered user can sign in with valid credentials
- Location: tests/auth/authentication.spec.ts:39:7
