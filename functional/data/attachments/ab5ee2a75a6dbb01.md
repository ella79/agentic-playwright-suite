...
- Name: tests/auth/authentication.spec.ts >> Authentication >> TC-06: logging out returns the visitor to the anonymous state
- Location: tests/auth/authentication.spec.ts:114:7
