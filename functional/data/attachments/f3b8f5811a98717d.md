...
- Name: tests/auth/authentication.spec.ts >> Authentication >> TC-04: signing up with an already registered email is rejected
- Location: tests/auth/authentication.spec.ts:68:7
